...
// reenable ace_zeus_autoAddObjects if it is off
if (isClass(configFile >> "CfgPatches" >> "ace_zeus") && {!ace_zeus_autoAddObjects}) then {
    systemChat "reenabling adding stuff to zeus";
